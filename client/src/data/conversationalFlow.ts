...
export const CONVERSATIONAL_ONBOARDING_FLOW: ConversationalFlow = {
  ...
  version: '4.2.0',
  description:
    'Onboarding conversationnel optimisé par IA avec recommandations personnalisées et flux adaptatifs',
  ...
  steps: [
    /* ============================= WELCOME ============================= */
    {
      ...
      description:
        "Je vais vous aider à créer votre programme personnalisé en quelques minutes grâce à l'intelligence artificielle.",
      illustration: '🏆',
    ...
    /* ========================= MAIN OBJECTIVE ========================== */
    {
      ...
      validation: [{ type: 'required', message: 'Veuillez sélectionner votre objectif principal' }],
    ...
    /* ========================= PACK SELECTION ========================== */
    {
      ...
      importance: 'critical',
      skippable: false,
      validation: [{ type: 'required', message: 'Veuillez sélectionner un pack' }],
    ...
    /* ======================= AI RECOMMENDATIONS ==================== */
    {
      ...
      description:
        "L'IA a analysé des milliers de profils similaires pour ces suggestions optimales",
      illustration: '🧠',
      inputType: 'multi-select',
      maxSelections: 6,

      options: AVAILABLE_MODULES.map(
      ...
      warnings: ['Sélectionner trop de modules peut diviser votre attention'],
    ...
    /* ========================== UPSELLS ========================== */
    {
      ...
      description:
        "L'IA peut créer des plans alimentaires personnalisés qui s'adaptent à vos goûts et contraintes",
      illustration: '🥗',
      inputType: 'single-select',
    ...
    /* ========================= PERSONAL INFO ======================= */
    {
      ...
      validation: [
        { type: 'required', message: 'Veuillez compléter les informations demandées' },
        {
          ...
          validator: data => data.age >= 13 && data.age <= 100,
        },
        {
          type: 'custom',
          message: 'Temps disponible requis',
          validator: data => data.availableTimePerDay >= 15,
        },
      ],
    ...
    /* ========================= MODULE: SPORT ========================= */
    {
      ...
      validation: [{ type: 'required', message: 'Veuillez sélectionner votre sport principal' }],
...

    {
      ...
      validation: [{ type: 'required', message: 'Veuillez sélectionner votre position' }],
...

    {
      ...
      options: SPORT_LEVELS.map(
        (level): QuestionOption => ({
          id: level.id,
          label: level.name,
          value: level.id,
      ...
      validation: [{ type: 'required', message: 'Veuillez sélectionner votre niveau' }],
...

    {
      ...
      condition: data =>
        data.selectedModules?.includes('sport') && data.sportLevel !== 'recreational',

      options: SEASON_PERIODS.map(
        (period): QuestionOption => ({
          id: period.id,
          label: period.name,
          value: period.id,
    ...
    /* ======================= MODULE: STRENGTH ======================= */
    {
      ...
      options: STRENGTH_OBJECTIVES.map(
        (obj): QuestionOption => ({
          id: obj.id,
          label: obj.name,
          value: obj.id,
...

    {
      ...
      options: FITNESS_EXPERIENCE_LEVELS.map(
        (level): QuestionOption => ({
          id: level.id,
          label: level.name,
          value: level.id,
...

    {
      ...
      options: NUTRITION_OBJECTIVES.map(
        (obj): QuestionOption => ({
          id: obj.id,
          label: obj.name,
          value: obj.id,
      ...
      options: [
        {
          ...
          label: 'Excellent',
          value: 5,
          description: 'Je me réveille toujours reposé(e)',
          icon: '🌟',
        },
        {
          id: 'good',
          label: 'Bon',
          value: 4,
          description: 'Généralement satisfaisant',
          icon: '😊',
        },
        {
          id: 'average',
          label: 'Moyen',
          value: 3,
          description: 'Parfois bon, parfois moins',
          icon: '😐',
        },
        {
          id: 'poor',
          label: 'Mauvais',
          value: 2,
          description: 'Souvent fatigué(e) au réveil',
          icon: '😴',
        },
        {
          id: 'very_poor',
          label: 'Très mauvais',
          value: 1,
          description: 'Je ne me sens jamais reposé(e)',
          icon: '😵',
        },
      ],

      validation: [{ type: 'required', message: 'Veuillez évaluer votre qualité de sommeil' }],
    ...
    /* ======================= MODULE: WELLNESS ====================== */
    {
      ...
      validation: [{ type: 'required', message: 'Veuillez évaluer votre niveau de stress' }],
...

    {
      ...
      validation: [{ type: 'required', message: 'Veuillez sélectionner au moins un objectif' }],
...

    {
      ...
      options: HEALTH_CONDITIONS.map(
        (condition): QuestionOption => ({
          id: condition.id,
      ...
      warnings: ['Consultez toujours un professionnel de santé avant de commencer'],
 ...
 */
export function getNextModuleStep(selectedModules: ModuleId[], currentModule?: string): string {
 ...
 */
export function getConditionalSteps(data: OnboardingData): ConversationalStep[] {
