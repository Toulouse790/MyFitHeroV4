...
export const queryKeys = {
  ...
  nutrition: {
    ...
    meals: (userId: string, date: string) =>
      [...queryKeys.nutrition.all, 'meals', userId, date] as const,
  ...
  recovery: {
    ...
    metrics: (userId: string, period: string) =>
      [...queryKeys.recovery.all, 'metrics', userId, period] as const,
    recommendations: (userId: string) =>
      [...queryKeys.recovery.all, 'recommendations', userId] as const,
  },
  ...
  analytics: {
    ...
    progress: (userId: string, type: string) =>
      [...queryKeys.analytics.all, 'progress', userId, type] as const,
  ...
  workouts: {
    templates: () =>
      queryClient.prefetchQuery({
        ...
        queryFn: () =>
          import('../features/workout/services/WorkoutService').then(m =>
            m.workoutService.getTemplates()
          ),
  ...
  nutrition: {
    foods: () =>
      queryClient.prefetchQuery({
        ...
        queryFn: () =>
          import('../features/nutrition/services/NutritionService').then(m =>
            m.nutritionService.getFoods()
          ),
