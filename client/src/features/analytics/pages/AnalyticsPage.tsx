...
const Analytics: React.FC = () => {
  ...
  const loadAnalyticsData = useCallback(async () => {
    ...
    try {
      ...
      const mockData: AnalyticsData = {
        ...
        total_calories:
          workoutStats?.reduce((sum: number, w: any) => sum + (w.calories_burned || 0), 0) || 3840,
        average_sleep: 7.5,
        hydration_rate: 88,
      };
  ...
  const handleExport = useCallback(
    async (format: ExportData['format']) => {
      ...
      <UniformHeader
        ...
        rightContent={
          <div className="flex items-center space-x-2">
            ...
            <Select
              value={periodFilter}
              onValueChange={(value: 'week' | 'month' | 'quarter') => setPeriodFilter(value)}
            >
              <SelectTrigger
      ...
      <div className="p-4 space-y-6 max-w-6xl mx-auto">
        ...
        <Card>
          <CardContent className="p-2">
            <Tabs
              value={activeTab}
              onValueChange={(value: 'tableau-bord' | 'rapports' | 'export' | 'social') =>
                setActiveTab(value)
              }
              className="space-y-6"
            >
                  ...
                  <Card className="bg-gradient-to-br from-green-50 to-green-100 border-green-200">
                    <CardContent className="p-4 text-center">
                      ...
                      <div className="text-2xl font-bold text-green-700">
                        {analyticsData.consistency_rate}%
                      </div>
                  ...
                  <Card className="bg-gradient-to-br from-orange-50 to-orange-100 border-orange-200">
                    <CardContent className="p-4 text-center">
                      ...
                      <div className="text-2xl font-bold text-orange-700">
                        {analyticsData.total_calories.toLocaleString()}
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 pt-4 border-t">
                      <div className="text-center">
                        <div className="text-lg font-bold text-green-600">
                          +{analyticsData.monthly_improvement}%
                        </div>
                        <div className="text-xs text-gray-500">Amélioration</div>
                      </div>
                      <div className="text-center">
                        <div className="text-lg font-bold text-blue-600">
                          Top {analyticsData.ranking_percentile}%
                        </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="font-bold text-blue-600">
                            {analyticsData.streak_days} jours
                          </span>
                        </div>
                        <Button
                          ...
                          onClick={() =>
                            toast({
                              ...
                              description: 'Rapport détaillé bientôt disponible',
                            })
                          }
                        >
                      ...
                      <div className="space-y-4">
                        ...
                        <Button
                          ...
                          onClick={() =>
                            toast({
                              title: 'Fonctionnalité en développement',
                              description: 'Comparaison détaillée bientôt disponible',
                            })
                          }
                        >
                      ...
                      <div className="flex items-start space-x-2">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-blue-700 mt-1">
                            ...
                            derniers jours : entraînements, nutrition, hydratation, sommeil,
                            progression {appStoreUser?.sport}
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <CardContent className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg">
                        ...
                        <div className="text-sm text-purple-600">
                          Classement global {appStoreUser?.sport}
                        </div>
                      </div>
                    ...
                    <div className="bg-amber-50 p-4 rounded-lg border border-amber-200">
                      <p className="text-sm text-amber-800 text-center">
                        🚧 Fonctionnalité en développement - Comparaison avec vos amis bientôt
                        disponible
                      </p>
                    </div>
                    ...
                    <div className="flex justify-center space-x-4">
                      <Button
                        ...
                        onClick={() =>
                          toast({
                            ...
                            description: "Invitation d'amis en développement",
                          })
                        }
                      >
                      ...
                      <Button
                        ...
                        onClick={() =>
                          toast({
                            title: 'Bientôt disponible',
                            description: 'Partage de stats en développement',
                          })
                        }
                      >
